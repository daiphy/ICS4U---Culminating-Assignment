...
public class Trends {
  ...
  public String[][] populateCat(ArrayList<String> categoryArrList, String[][] twoDArr, String month){
    ...
    int addEmpty = twoDArr.length - categoryArrList.size(); // 7 - size of arrlist
  ...
  public double sumCalculator(String[][] twoDArr){
    ...
    //Loops through a 2D array (either the income or expense array)
    //Adds the values of the anticipated income/expense
    for(int i = 1; i < twoDArr.length; i++){
  ...
  public double sumAccCalculator(String[][] twoDArr){
    ...
    //Loops through a 2D array (either the income or expense array)
    //Adds the values of the actual income/expense
    for(int i = 1; i < twoDArr.length; i++){
  ...
  public double endBalance(double startingBalance, double accSavings){
    //Adds the starting/original balance and the actual savings in a given month
