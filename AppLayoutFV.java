...
public class AppLayoutFV extends Application{
    ...
    public Scene baseScene(Stage stage, String whichType, ComboBox cBInc, ComboBox cBExp){
        ...
        StackPane stackPaneT = showSPane(catAmnt, cat, amnt);
        StackPane stackPaneB = showSPane(catAmnt, cat, amnt);
        ...
        // yellowButtonNAME.setStyle("-fx-font: 16 verdana; -fx-base: #f8f3c9;");
    ...
    public StackPane showSPane(Text catAmnt, Text cat, Text amnt){
